...
namespace localizer.product.player
{
    public class LearnVRControllers1 : MonoBehaviour
    {
        ...
        //        //{
        //        //    //register with TrakerUserInput event
        //        //    trackerUserInput.OnUserPressed += ActionIfUserPresses;
        //        //}
        //        //private void OnDisable()
        //        //{
        //        //    //unregister with TrakerUserInput event
        //        //    trackerUserInput.OnUserPressed -= ActionIfUserPresses;
        //        //}

        //        private void OnEnable()
        //        {
        //            tutorialManager.isLearnVRFinished += 
        //        }
        ...
        //        {
        //            //stop all running coroutines before you listen again.
        //            StopAllCoroutines();
        ...
        //            Debug.Log($"the keyword related to this entry: {relatedButton}");

        //            if (string.IsNullOrEmpty(relatedButton))
        //            {
        //                //count++;
        //                //return;
        ...
        //        //    if (trackerUserInput.pressedKeys.Contains(actualEntry)) ToDoIfUserPasses();
