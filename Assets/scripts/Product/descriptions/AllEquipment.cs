...
namespace localizer.product.descriptions
{
    ...
    public static class ActionsDescriptions
    {
        ...
        {
            ["Welcome to VR"] = new ToDoModel { Description ="Hello, You're going to be taken through a few steps to make sure you're ready to navigate yourself around the next upcoming scenes. So seat back, relax and hold your VR controllers in both hands. Try pressing to continue"},
            ["Clicking buttons and switches"] = new ToDoModel { ControllerKey = "Select", Description = "Point the controller to the button or switch of interest, once the ray from the controller turns orange, press the grip button once. (Grip Button is the big button on the inner side of the controller where the folding fingers rest). Try pressing to continue" },
            ["Straight locomotion"] = new ToDoModel {ControllerKey = "Position",  Description = "With your left controller, push the thumbstick forward to glide forward (Thumbstick is the tallest button on the top of the controller and can be pushed around in a 360 degree movement), backwards to glide back, and sideways to move either to the left or right. Try pressing to continue" },
            ["Rotating Around"] = new ToDoModel {ControllerKey = "Rotate Manipulation", Description = "With your right controller, push the thumbstick to the right or left to turn accordingly. Note: To avoid nausea, we provide snap turning. Try pressing to continue" },
            ["Opening and closing Doors"] = new ToDoModel {ControllerKey = "Select", Description = "Point the controller to the door knob, the ray from the controller will turn orange once it detects the knob, hold the grip button and move your hand as if you are pulling or pushing the door. Try pressing to continue" },
